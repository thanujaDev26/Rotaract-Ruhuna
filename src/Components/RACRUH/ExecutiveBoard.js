...
const executiveBoardMembers = [
    {
        id: 1,
        name: 'Nuhansi Gunawardena',
        designation: 'President',
        imageUrl: nuhansiUrl,
    },
    {
        id: 2,
        name: 'Gayan Jayawardena',
        designation: 'Vice President',
        imageUrl: gayanUrl,
    },
    {
        id: 3,
        name: 'Kavishka Tissera',
    ...
    {
        id: 5,
        name: 'Kalindu Abeygunawardena',
        designation: 'Sergeant at Arms',
        imageUrl: kalinduUrl,
    },
    {
        id: 6,
        name: 'Rumesha Maduwanthi',
        designation: 'Co-Editor',
        imageUrl: rumeshaUrl,
    },
    {
        id: 7,
        name: 'Virasha Godakanda',
        designation: 'Co-Editor',
        imageUrl: virashaUrl,
    },
];
...
const ExecutiveBoard = () => {
    ...
    const scrollLeft = () => {
        if (boardRef.current) {
            const itemWidth = boardRef.current.firstElementChild.clientWidth; // Get width of each item
            const scrollAmount = itemWidth + 20; // Adjust as needed (include margin)

            // Calculate new scroll position
            let newScrollLeft = boardRef.current.scrollLeft - scrollAmount;

            // Wrap around if scrolling past the beginning
            if (newScrollLeft < 0) {
    ...
    const scrollRight = () => {
        if (boardRef.current) {
            ...
            // Wrap around if scrolling past the end
        ...
        <div className="bg-white">
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="relative overflow-hidden">
                    <div ref={boardRef} className="flex space-x-6 sm:space-x-8 lg:space-x-10 xl:space-x-12 overflow-x-auto">
